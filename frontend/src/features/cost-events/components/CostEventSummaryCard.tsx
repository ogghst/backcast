...
import { useCostEventSummary } from "../api/useCostEvents";
import { useProject } from "@/features/projects/api/useProjects";

interface CostEventSummaryCardProps {
  projectId: string;
}

export const CostEventSummaryCard = ({
  projectId,
}: CostEventSummaryCardProps) => {
  const { spacing, colors, borderRadius, typography } = useThemeTokens();
  const { data: summary, isLoading } = useCostEventSummary(projectId);
