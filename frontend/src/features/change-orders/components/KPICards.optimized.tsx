...
/**
 * Single KPI Metric Card component - memoized to prevent unnecessary re-renders
 */
const KPIMetricCard = memo(function KPIMetricCard({
  title,
  metric,
}: {
  title: string;
...
/**
 * Performance Index Card (CPI, SPI, TCPI) - memoized.
 * Shows the index value with target indicator.
 */
const PerformanceIndexCard = memo(function PerformanceIndexCard({
  title,
  metric,
  target,
}: {
...
/**
 * Schedule Duration Card - memoized.
 * Shows duration in days with color coding for schedule changes.
 */
const ScheduleDurationCard = memo(function ScheduleDurationCard({
  title,
  metric,
}: {
  title: string;
...
/**
 * KPICards Component - memoized to prevent re-renders when parent updates
 *
