...
export class WbEsService {
   ...
   * @throws ApiError
   */
  public static createWbe(requestBody: WBECreate): CancelablePromise<WBERead> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/v1/wbes",
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static getWbe(wbeId: string): CancelablePromise<WBERead> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static deleteWbe(wbeId: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/api/v1/wbes/{wbe_id}",
      path: {
