...
export interface WBSElementTablePagination {
  current: number;
  pageSize: number;
  total: number;
...
interface WBSElementTableProps {
  wbes: WBSElementRead[];
  loading?: boolean;
  onRowClick?: (wbe: WBSElementRead) => void;
  variant?: ViewMode;
  pagination?: WBSElementTablePagination;
  currency?: string;
}

export const WBSElementTable = ({
  wbes,
  loading,
  onRowClick,
  variant = "auto",
  ...
  const columns: ColumnType<WBSElementRead>[] = useMemo(() => {
    const cols: ColumnType<WBSElementRead>[] = [
      {
        title: "Code",
        dataIndex: "code",
        key: "code",
