...
class TestAIRoles:
    ...
    def test_ai_manager_has_crud_permissions(self) -> None:
        ...
        allowed_permissions = [
            ...
            "cost-element-read", "cost-element-create", "cost-element-update",
            "cost-element-type-read",
            "cost-registration-read", "cost-registration-create",
            "cost-registration-update", "cost-registration-delete",
            "change-order-read", "change-order-create", "change-order-update",
            "change-order-submit", "change-order-approve",
            "forecast-read", "forecast-create", "forecast-update",
            "schedule-baseline-read", "schedule-baseline-create",
            "schedule-baseline-update",
            "progress-entry-read", "progress-entry-create",
            "progress-entry-update", "progress-entry-delete",
            "quality-event-read", "quality-event-create",
            "quality-event-update", "quality-event-write",
            "evm-read", "evm-create", "evm-update", "evm-delete",
            "ai-chat",
        ]
        denied_permissions = [
            "project-delete",
    ...
    def test_ai_admin_has_admin_permissions(self) -> None:
        ...
        allowed_permissions = [
            ...
            "cost-element-type-read", "cost-element-type-create",
            "cost-element-type-update", "cost-element-type-delete",
        ]
        denied_permissions = [
            "wbe-create",
            "wbe-update",
