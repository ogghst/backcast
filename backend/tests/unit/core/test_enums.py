...
class TestChangeOrderStatus:
    ...
    def test_status_values(self) -> None:
        ...
        assert (
            ChangeOrderStatus.SUBMITTED_FOR_APPROVAL.value == "submitted_for_approval"
        )
        assert ChangeOrderStatus.UNDER_REVIEW.value == "under_review"
    ...
    def test_status_with_spaces(self) -> None:
        ...
        assert ChangeOrderStatus.SUBMITTED_FOR_APPROVAL == "submitted_for_approval"
        assert ChangeOrderStatus.UNDER_REVIEW == "under_review"
