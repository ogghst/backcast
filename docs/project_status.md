...
| E4-012 | AI Assisted Project comments | Implement an AI generated project assessment, based on the project metrics. The configuration of the OpenAI base url and key shall be performed at user level in administration interface. |
