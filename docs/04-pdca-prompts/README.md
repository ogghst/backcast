...
| **Next Iteration**                    | [`next-iteration.md`](next-iteration.md)     |
| **Prompt history & changes**          | [`prompt-changelog.md`](prompt-changelog.md) |
...
- **Act**: Standardize improvements and close the iteration

These are used by the `project-plan-implementer` agent when working on features from the product scope.
