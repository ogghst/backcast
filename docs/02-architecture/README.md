...
| Implement API endpoints             | [`cross-cutting/api-conventions.md`](cross-cutting/api-conventions.md) + [`cross-cutting/api-response-patterns.md`](cross-cutting/api-response-patterns.md) |
