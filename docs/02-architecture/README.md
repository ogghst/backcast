...
| Write code (backend)                | [`backend/coding-standards.md`](backend/coding-standards.md) - Core principles, type safety, patterns, quality gates                                                                          |
| Write code (frontend)               | [`frontend/coding-standards.md`](frontend/coding-standards.md) - Core principles, type safety, patterns, quality gates                                                                        |
