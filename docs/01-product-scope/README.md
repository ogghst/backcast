...
**Purpose:** Define what the system does and why it exists.
...
**"How should feature X work?"** → [functional-requirements.md](functional-requirements.md)
**"What does EVM term Y mean?"** → [evm-requirements.md](evm-requirements.md) + [glossary.md](glossary.md)
